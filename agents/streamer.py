"""
Live WebSocket Distributed Component Telemetry Streamer for wsi-tiler-qc-agent.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "wsi-tiler-qc-agent", "event_type": event_type, "payload": data})

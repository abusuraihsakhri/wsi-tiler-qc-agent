...
**WSI Tiler Qc Agent** is an advanced analytical and computational platform implementing Gigapixel WSI Tiling, Focus Entropy Mapping & Artifact Filter.
...
- **`TissueSegmentationAgent`**: Specialized Sub-Agent 1 for wsi-tiler-qc-agent
- **`FocusEntropyAgent`**: Specialized Sub-Agent 2 for wsi-tiler-qc-agent
- **`ArtifactExclusionAgent`**: Specialized Sub-Agent 3 for wsi-tiler-qc-agent
...
docker run -p 8000:8000 wsi-tiler-qc-agent
```
